...
CREATE POLICY "allow all delete" ON "public"."form_submissions" FOR DELETE TO "authenticated", "anon" USING (true);



CREATE POLICY "allow all insert" ON "public"."form_submissions" FOR INSERT TO "authenticated", "anon" WITH CHECK (true);



CREATE POLICY "allow all select" ON "public"."form_submissions" FOR SELECT TO "authenticated", "anon" USING (true);



CREATE POLICY "allow all update" ON "public"."form_submissions" FOR UPDATE TO "authenticated", "anon" USING (true) WITH CHECK (true);
