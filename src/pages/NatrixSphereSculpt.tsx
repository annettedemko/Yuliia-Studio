      ...
      <section className="relative min-h-screen bg-[#0a0a0a] overflow-hidden flex items-center">
        ...
        <div className="container mx-auto px-4 relative z-10 py-20">
          <div className="flex flex-col-reverse lg:flex-row items-center gap-8 lg:gap-0">
            ...
            <div className="relative w-full lg:w-1/2 flex justify-center group min-h-[500px] sm:min-h-[600px] lg:min-h-[650px] items-center">
              {/* Glow ring */}
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[420px] h-[420px] sm:w-[550px] sm:h-[550px] rounded-full border border-[#C5A572]/10 group-hover:border-[#C5A572]/25 group-hover:scale-110 transition-all duration-1000" />
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[350px] h-[350px] sm:w-[470px] sm:h-[470px] rounded-full bg-[#C5A572]/[0.04] group-hover:bg-[#C5A572]/[0.08] blur-3xl transition-all duration-1000" />
              <img
                src="/Natrix/сфера лицо.png"
                alt={t('natrix.sphere.handpiece.face.alt')}
                className="relative z-10 w-full max-w-[400px] sm:max-w-[500px] lg:max-w-[560px] h-auto object-contain drop-shadow-[0_0_60px_rgba(197,165,114,0.15)] group-hover:scale-105 group-hover:drop-shadow-[0_0_80px_rgba(197,165,114,0.25)] transition-all duration-700"
                loading="lazy"
              />
            </div>
          </div>
