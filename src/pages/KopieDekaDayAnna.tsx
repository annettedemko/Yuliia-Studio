...
const KopieDekaDayAnna = () => {
  ...
  useEffect(() => {
    console.log('KopieDekaDayAnna page - loading events');
    initializeContentData();
    cleanupPastEvents();
    const events = getUpcomingEvents();
    console.log('KopieDekaDayAnna loaded events:', events);
  ...
  return (
    <div className="min-h-screen pt-16">
      {/* Hero Section */}
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-emerald-900 via-teal-900 to-slate-800">
        ...
        <div className="absolute inset-0 opacity-15">
          <div className="grid grid-cols-3 md:grid-cols-5 gap-6 h-full w-full p-8 items-center justify-items-center">
            <div className="animate-float-5">
              <img src="/deka5.png" alt="Again cos" className="w-28 md:w-36 h-auto opacity-70 hover:opacity-90 transition-opacity duration-500" />
            </div>
            <div className="animate-float-3">
              <img src="/deka3.png" alt="Motus AX" className="w-24 md:w-32 h-auto opacity-60 hover:opacity-80 transition-opacity duration-500" />
            </div>
            <div className="animate-float-2 col-span-1 md:col-span-1">
              <img src="/deka2.png" alt="RedTouch PRO" className="w-32 md:w-40 h-auto opacity-80 hover:opacity-100 transition-opacity duration-500" />
            </div>
            ...
            <div className="animate-float-4">
              <img src="/deka4.png" alt="PHYSIQ 360" className="w-26 md:w-34 h-auto opacity-65 hover:opacity-85 transition-opacity duration-500" />
            </div>
          </div>
        </div>
        ...
        <div className="relative z-10 text-center px-4 max-w-6xl mx-auto">
          <div className="animate-fade-in-up">
            ...
            <p className="text-xl md:text-2xl text-gray-300 mb-12 max-w-4xl mx-auto leading-relaxed animate-fade-in-up delay-500">
              Erleben Sie die Elite der Kosmetiktechnologie.<br/>
              <span className="text-emerald-300 font-medium">Exklusiv • Präzise • Transformativ</span>
            </p>
