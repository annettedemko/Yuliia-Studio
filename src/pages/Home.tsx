...
const Home = () => {
  ...
  return (
    <div className="min-h-screen pt-16">{/* Add padding-top for fixed navigation */}
      ...
      <section id="subscriptions" className="py-12 bg-gradient-to-br from-accent/20 via-white to-rose-gold/5 relative overflow-hidden">
      ...
      {/* Map Section */}
      <section className="py-12 bg-accent/20 relative overflow-hidden">
      ...
      {/* Contact Section */}
      <section id="contact" className="py-12 bg-accent/30 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
            {/* Contact Info */}
            <div className="space-y-8 animate-slide-up delay-500">
              <div className="flex items-center space-x-4 group hover:scale-105 transition-all duration-300 p-4 rounded-xl hover:bg-white/50">
              ...
              <div className="flex items-center justify-center">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="bg-gradient-to-br from-pink-500 to-purple-600 hover:from-pink-600 hover:to-purple-700 p-4 rounded-full transition-all duration-300 hover:scale-110 hover:shadow-lg group"
                  title="Instagram"
                >
