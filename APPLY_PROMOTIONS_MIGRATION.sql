-- ВАЖНО: Этот SQL нужно выполнить в Supabase Studio (SQL Editor)
-- Перейдите в: https://supabase.com/dashboard/project/knmompemjlboqzwcycwe/sql/new
...
-- Проверка: Должно вернуть 3 записи
SELECT * FROM public.promotions WHERE is_active = true ORDER BY display_order;
